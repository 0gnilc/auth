...
const emit = defineEmits<{
  ...
  notificationRemove: [NotificationItem];
  notificationViewAll: [];
}>();
        ...
        >
          ...
          >
            <Notification
              ...
              :notifications
              class="mr-2"
              @clear="emit('notificationClear')"
              @make-all="emit('notificationMakeAll')"
              @on-click="emit('notificationClick', $event)"
              @read="emit('notificationRead', $event)"
