...
- Read [`CONTEXT.md`](CONTEXT.md) and the relevant ADRs in [`docs/adr/`](docs/adr/) before changing administrator, RBAC, menu, or dynamic internationalization behavior.
...
- Keep Message Key persistence separate from the enclosing business-resource save, as defined by the local ADRs.
